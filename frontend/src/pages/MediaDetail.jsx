    ...
    media ? (
      <>
        ...
        <Box sx={{
              ...
              <Box sx={{
                ...
                <Stack spacing={5}>
                  ...
                  <Stack direction="row" spacing={1}>
                    ...
                    <Button
                      variant="contained"
                      sx={{ width: "max-content", backgroundColor: "blue", color: "white" }}
                      size="large"
          ...
          <Container header="Você também pode gostar">
